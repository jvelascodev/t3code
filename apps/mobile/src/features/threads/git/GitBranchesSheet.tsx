      ...
      <MaterialScreenContent fitToContents>
        ...
        >
          {!gitActions.canChangeWorkspace ? (
            <Text className="text-foreground-secondary p-4">
              {gitActions.isCoordinatorChat
                ? "Agent conversations use the project workspace. Start a task thread to choose a branch or worktree."
